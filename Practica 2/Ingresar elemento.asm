;Escribir una programa que reciba una cadena ingresada por teclado, terminada en ENTER. 
;Luego que elimine todos los caracteres que no son dígitos, sin utilizar una variable auxiliar.
ORG 100H
mov si, 0
lectura:
 mov ah,1
